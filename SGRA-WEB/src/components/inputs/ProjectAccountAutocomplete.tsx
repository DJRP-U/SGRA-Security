...
type Props = {
    ...
    width?: string;
    value: string;
    onChange: (value: string) => void;  // actualizar correo cambiam nombre depuse
    onSelectedIdChange: (uuid: string) => void; // actualizar uuid 
};

export default function ProjectAccountAutocomplete({
    label,
    id,
    placeholder,
    required = false,
